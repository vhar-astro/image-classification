...
This is a cross-platform dual-mode C++ GUI application for **Windows 10** and **Linux/Ubuntu** that assists with preparing machine learning datasets. It provides intuitive Qt5-based interfaces for:
